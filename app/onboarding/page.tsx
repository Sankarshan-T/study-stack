        ...
        <div className="h-full p-6 flex items-center justify-center">
            <div className="w-full max-w-[70%] space-y-8">
                <div className="text-center space-y-2">
                    <h1 className="text-4xl font-bold text-primary flex gap-x-3 items-baseline justify-center">
                ...
                <div className="grid grid-cols-2 gap-8 items-start">
                    ...
                    <div className="rounded-2xl border border-chart-5 bg-purple-200/40 p-6 h-[30vh]">
                        ...
                        <div className="mt-7 rounded-xl bg-purple-100 border-chart-4 border p-4">
